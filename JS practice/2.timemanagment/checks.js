...
var time = date('2017-05-16 13:45').add(24, 'hours').add(3, 'days').add(15, 'minutes').subtract(1, 'months');
  //.add(24, 'hours')
  // .subtract(1, 'months')
  //.add(3, 'days')
  //.add(15, 'minutes');

console.log('console: ' + typeof time.value);
console.log('console: ' + time.value);
console.log('console: ' + typeof time.tmpDate);
console.log('console: ' + time.tmpDate);
